...
queries = {
    "95tile": {
        "query": 'SELECT "95tile" FROM "measurements.tangerine" WHERE ("region" =~ /^USS/ AND "latencyType" = "client.update.message.loadAndSend") AND time >= 1695907248642ms and time <= 1695916384594ms GROUP by "messageType"',
